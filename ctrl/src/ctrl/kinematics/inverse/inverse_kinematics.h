 ...
 *
 *              double phi2_f_u = -1*(alpha1+alpha2);
 *              double phi2_f_d = -1*(alpha2-alpha1);
 *
 *              double phi3_f_u = 360-beta-asin(b/d2)-90;
 *              double phi3_f_d = beta-asin(b/d2)-90;
 *
 *              if(-185< phi1 < 185)
 *              {
 *                  if(-140<phi2_f_u<-5)
 ...
 *              double alpha2 = asin(dpy/d3);
 *
 *              double phi2_b_u = -1*(180-(alpha1+alpha2);
 *              double phi2_b_d = -1*(180-(alpha2-alpha1);
 *
 *              double phi3_b_u = 270-beta-asin(b/d2);
 *              double phi3_b_d = -1*(90-(beta-asin(b/d2)));
 *
 *              if(-185< phi1 < 185)
 *              {
 *                  if(-140<phi2_b_u<-5)
