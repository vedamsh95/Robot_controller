...
std::array<double, 6> InvKinematics::inv_solution(double phi1, double d1){
    ...
    else if(d1>m && -175<phi1<175)                                                                               //calculating all the forward cases
    {
        ...
        if (-185 < phi1 && phi1 < 185) {
            ...
            if (-140 < phi2_f_u && phi2_f_u < -5) {
                std::cout << "phi2: " << phi2_f_u << std::endl;
                if (-120 < phi3_f_u && phi3_f_u < 168) {
                    std::cout << "phi3: " << phi3_f_u << std::endl;
                    solution[0] = phi1;
                    solution[1] = phi2_f_u;
                    solution[2] = phi3_f_u;
                    return solution;
            ...
            else if (-140 < phi2_f_d < -5) {
                std::cout << "phi2: " << phi2_f_d << std::endl;
                if (-120 < phi3_f_d && phi3_f_d < 168) {
                    std::cout << "phi3: " << phi3_f_d << std::endl;
                    solution[0] = phi1;
                    solution[1] = phi2_f_d;
                    solution[2] = phi3_f_d;
                    return solution;
                }
               else if(-120 < phi3_f_d_1 && phi3_f_d_1 < 168){
                    std::cout << "phi3: " << phi3_f_d << std::endl;
                    solution[0] = phi1;
                    solution[1] = phi2_f_d;
                    solution[2] = phi3_f_d_1;
                    return solution;
                }
            }
        }
    ...
    else if(d1 < m && -175 < phi1 < 175)                              //calculating all the backward cases
    {
        ...
        if (-185 < phi1 < 185) {
            std::cout << "phi1: " << phi1 << std::endl;
            if (-140 < phi2_b_u < -5) {
                std::cout << "phi2: " << phi2_b_u << std::endl;
                if (-120 < phi3_b_u < 168) {
                    std::cout << "phi3: " << phi3_b_u << std::endl;
                    solution[0] = phi1;
                    solution[1] = phi2_b_u;
                    solution[2] = phi3_b_u;
                    return solution;
            ...
            if (-140 < phi2_b_d < -5) {
                std::cout << "phi2: " << phi2_b_d << std::endl;
                if (-120 < phi3_b_d && phi3_b_d < 168) {
                    std::cout << "phi3: " << phi3_b_d << std::endl;
                    solution[0] = phi1;
                    solution[1] = phi2_b_d;
                    solution[2] = phi3_b_d;
                    return solution;
                ...
                else if (-120 < phi3_b_d_1 < 168){
                    std::cout << "phi3: " << phi3_b_d_1 << std::endl;
                    solution[0] = phi1;
                    solution[1] = phi2_b_d;
                    solution[2] = phi3_b_d_1;
                    return solution;
                }
            }
            else {
                cout << "Pose is unreachable for the robot" << endl;
            }
        }
    }
