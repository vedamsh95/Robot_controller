...
public:
    ...
    /**
     * Constructor for the the TMatrix set up with the parameters from the Denavit Hartenberg method.
     *
     * @param _rot_alpha rotation around TODO
     * @param _rot_theta rotation around TODO
     * @param _trans_rx translation TODO
     * @param _trans_dz translation TODO
     */
    TMatrix(double _rot_alpha, double _rot_theta, double _trans_rx, double _trans_dz);
     ...
     */
    TMatrix(double _one, double _two, double _three, double _four, double _five, double _six, double _seven,
