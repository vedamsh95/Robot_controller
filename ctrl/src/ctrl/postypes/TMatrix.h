...
public:
     ...
     *
     * @param _rot_theta rotation
     * @param _rot_alpha rotation
     * @param _trans_rx translation
     * @param _trans_dz translation
     */
    TMatrix(double _rot_theta, double _rot_alpha, double _trans_rx, double _trans_dz);
