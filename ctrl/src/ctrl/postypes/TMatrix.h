...
public:
	...
	/**
	 * Returns a single element specified by the row and column
	 *
	 * @param row: starting with 0
	 * @param col: starting with 0
	 * @return The element at the given location
	 */
	double get(int row, int col) const;

	/**
	 * Multiplies the given matrix from the right to this matrix.
	 *
	 * @param right: Homogeneous transformation matrix to multiply from the right
	 *               to this one.
     ...
     */
	  ...
	  */
  friend std::ostream& operator<<(std::ostream &out, const TMatrix& c);
};
