...
Trajectory* Ptp::get_ptp_trajectoy(Configuration* _start_cfg, Configuration* _end_cfg)
{
    ...
    double a_max = 100;     // max acceleration

    double joint1_v_max = 120;     //max speed of joint1 in °/s
    double joint2_v_max = 115;     //max speed of joint 1 in °/s
    double joint3_v_max = 120;     //max speed of joint 1 in °/s
    double joint4_v_max = 190;     //max speed of joint 1 in °/s
    double joint5_v_max = 180;     //max speed of joint 1 in °/s
    double joint6_v_max = 260;     //max speed of joint 1 in °/s
    ...
    if (joint3_t_f > joint2_t_f){
        max_t_f = joint3_t_f;
    }
    if (joint4_t_f > joint3_t_f){
        max_t_f = joint4_t_f;
    }
    if (joint5_t_f > joint4_t_f){
        max_t_f = joint5_t_f;
    }
    if (joint6_t_f > joint5_t_f){
        max_t_f = joint6_t_f;
    }
    ...
    std::cout << "max_t_f :" << max_t_f << std::endl;
        ...
        for (int r = 0; r <= (max_t_f * 100); ++r) { //r = 1 will be 0.01s; so r = 100 = 1s
            ...
            if(joint1_max_vel_profile == true) {
                ...
                joint1_t_pos = res.trapezoidal_profile(joint1_startpos, joint1_distance, joint1_endpos, joint1_t_m,
            ...
            if(joint2_max_vel_profile == true) {
                ...
                joint2_t_pos = res.trapezoidal_profile(joint2_startpos, joint2_distance, joint2_endpos, joint2_t_m,
            ...
            if(joint3_max_vel_profile == true) {
                ...
                joint3_t_pos = res.trapezoidal_profile(joint3_startpos, joint3_distance, joint3_endpos, joint3_t_m,
            ...
            if(joint4_max_vel_profile == true) {
                ...
                joint4_t_pos = res.trapezoidal_profile(joint4_startpos, joint4_distance, joint4_endpos, joint4_t_m,
            ...
            if(joint5_max_vel_profile == true) {
                ...
                joint5_t_pos = res.trapezoidal_profile(joint5_startpos, joint5_distance, joint5_endpos, joint5_t_m,
            ...
            if(joint6_max_vel_profile == true) {
                ...
                joint6_t_pos = res.trapezoidal_profile(joint6_startpos, joint6_distance, joint6_endpos, joint6_t_m,
        ...
        config_vec.push_back(new Configuration({joint1_t_pos, joint2_t_pos, joint3_t_pos, joint4_t_pos, joint5_t_pos, joint6_t_pos}));


    }
    trajectory->set_trajectory(config_vec);
    std::cout << "trajectory: " << config_vec.at(260)->operator[](1) << std::endl;
    //Dummy trajectory
